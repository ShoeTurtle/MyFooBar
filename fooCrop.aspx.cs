...
public partial class _Default : System.Web.UI.Page
{
    ...
    public void CropFile(Int32 X, Int32 Y, Int32 Width, Int32 Height)
    {
        try
        {
            ...
            g.Dispose();
            ppname = "Profile" + Session["UserName"].ToString() + ".jpg";
            ...
            //Check Out Page.ResolveURL// */


            /*Updating The Profile Picture*/
            String cmdStr = "UPDATE General_Information SET ProfilePic = '" + ppname + "' WHERE UName = '" + myUserID + "'";
